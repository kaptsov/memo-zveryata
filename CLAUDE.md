...
- **Режим заданий** (AudioManager.task_random_mode):
  - false = классический: карточки задания показывают требуемых животных
  - true = рандомный: показывают случайные карты с доски (задание то же, визуал другой)
  - Сохраняется в settings.cfg, переключается в Настройках
...
- [x] **Сложные задания (2 очка) в соло-режиме** — добавляются если ≥4 животных одного сезона на доске
- [x] **Режим заданий: Классический / Рандомный** — переключатель в Настройках, действует на все режимы
  - Классический: карточки-задания показывают требуемые пары (стандартно)
  - Рандомный: карточки-задания показывают случайные карты с доски (визуальная маскировка)
- [x] Убраны эмодзи из настроек (⚙️🎵🔊) — веб-совместимость
